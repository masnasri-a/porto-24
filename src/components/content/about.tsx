...
const About = () => {
    return (
        <div className="">
            <div className='flex justify-center md:pl-72 pl-2 md:pr-72 flex-col md:flex-row pr-2 gap-5 md:gap-32 pt-24'>
                <div className="side-left flex text-center flex-col md:w-52 w-full gap-5 justify-center ">
                ...
                <div className="right-side w-full md:w-6/12 ">
                    <Image src={Profile} alt="profile" className='object-cover h-72' />
                </div>
            </div>
            <div className="career flex justify-center mt-10 md:mt-32">
                <div className="row w-full md:w-8/12">
                    <div className="col gap-5 flex md:flex-row flex-col items-center justify-between">
                        <div className="intro flex flex-col text-start gap-3 w-10/12 md:w-7/12">
                        ...
                        <div className="project-2 flex flex-col md:flex-row text-center md:text-start gap-3 ">
